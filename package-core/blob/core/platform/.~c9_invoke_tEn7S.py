        ...
        if driver:
            ...
            if target and target.get('driver'):
                ...
                if target_driver:
                    ...
                    target_connection_result = target_driver.connect_function(target_module, target.get('configuration', {}), function_name, service) 
            return (driver.connect_function(function_name, service.get('configuration', {}), target_module, target), target_connection_result)
...
def deploy_schedule(schedule_name, options, non_system_schedule_configuration={}):
...
def remove_schedule(schedule_name, options, non_system_schedule_configuration={}):
    ...
    if schedule and schedule.get('driver'):
        try:
            ...
            driver = None
        if driver:
            driver.remove_schedule(schedule_name, options, schedule.get('configuration', {}))
