...
** 2 -- /_/connection/{connection_id}.json 
     ...
     ** clear views for this connection
...
** 5 -- /_/connection/{connection_id}/query/{class_name}/{query_id}.json 
    ...
    ** re-build all indexes of this query
    ** clear views of this query for all feeding connections
...
** 5 -- /_/connection/{connection_id}/record/{class_name}/{record_id}.json
    ...
    ** calculate cached views of this record and updated queries
